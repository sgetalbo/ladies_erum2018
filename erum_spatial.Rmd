...
BUD_dist <- readOGR("~/Dropbox/R_ladies/R_Ladies_Manchester/Bud.shp") #Polygons layer

BUD_WATER <- readOGR("~/Dropbox/R_ladies/R_Ladies_Manchester/budwet.shp") #Waterways layer
...
```{r, message=FALSE}
# Use the whole filepath not just the extension from your working directory
Man_LSOA <- readOGR("~/Dropbox/R_ladies/R_Ladies_Manchester/E08000003_IMD/E08000003.shp") #Polygons layer
```
